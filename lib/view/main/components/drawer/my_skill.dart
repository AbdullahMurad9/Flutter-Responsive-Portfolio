...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.96, title: 'Flutter',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.96, title: 'Dart',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Firebase',image: 'assets/icons/firebase.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Sqlite',image: 'assets/icons/dart.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.93, title: 'Riverpod',image: 'assets/images/riverpod.png'),
        ...
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Spring',image: 'assets/images/spring-boot.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Hibernate',image: 'assets/images/hibernate.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Database',image: 'assets/images/db.png'),
      ],);
  }
}
